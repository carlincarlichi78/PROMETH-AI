...
import { Home, Upload, FolderOpen, Bell, User } from 'lucide-react-native'
...
export default function EmpresarioLayout() {
  return (
    <Tabs screenOptions={{
      ...
      <Tabs.Screen name="documentos" options={{ title: 'Docs', tabBarIcon: ({ color }) => <FolderOpen size={22} color={color} /> }} />
