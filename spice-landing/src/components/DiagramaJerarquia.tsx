...
const niveles = [
  {
    ...
    maxW: 'max-w-4xl',
    fondo: 'bg-amber-900/40 border-prometh-amber',
  },
  {
    nivel: 1,
  ...
  },
  {
    ...
    maxW: 'max-w-[22rem]',
    fondo: 'bg-prometh-amber/20 border-prometh-amber/40',
  },
]
  ...
  return (
    <section id="jerarquia" className="py-20 px-4" ref={ref}>
      <div className="max-w-6xl mx-auto">
        ...
        <div className="relative">
          ...
          <div className="hidden md:flex absolute -left-2 top-0 bottom-16 w-16 flex-col items-center justify-between">
            ...
            <div className="relative flex-1 flex flex-col items-center">
              <span className="text-xs font-heading font-bold text-prometh-amber tracking-widest rotate-0 mb-2">
                MAX
              </span>
              <div className="flex-1 w-px bg-gradient-to-b from-prometh-amber via-prometh-amber/50 to-prometh-amber/30 relative">
                {/* Punta superior */}
                <div className="absolute -top-1 left-1/2 -translate-x-1/2 w-0 h-0 border-l-[5px] border-r-[5px] border-b-[8px] border-l-transparent border-r-transparent border-b-prometh-amber" />
                {/* Punta inferior */}
                <div className="absolute -bottom-1 left-1/2 -translate-x-1/2 w-0 h-0 border-l-[5px] border-r-[5px] border-t-[8px] border-l-transparent border-r-transparent border-t-prometh-amber/40" />
              </div>
              <span className="text-xs font-heading font-bold text-prometh-amber/60 tracking-widest mt-2">
                MIN
              </span>
            </div>
            {/* Texto vertical AUTORIDAD */}
            <div className="absolute top-1/2 -translate-y-1/2 -rotate-90 whitespace-nowrap">
              <span className="text-sm font-heading font-bold text-prometh-muted/50 tracking-[0.3em] uppercase">
                Autoridad
              </span>
            </div>
          </div>
              ...
              >
                <div className="flex items-start gap-3 md:gap-4">
                  ...
                  <div className="flex-shrink-0 w-9 h-9 rounded-full bg-white/10 flex items-center justify-center">
                    <span className="text-sm font-heading font-bold text-prometh-text">
                      {n.nivel}
                    </span>
                  </div>
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-prometh-muted text-sm mt-0.5">
                      {n.descripcion}
                    </p>
                    <p className="text-prometh-text/60 text-xs md:text-sm mt-1 italic">
                      Ej: {n.ejemplo}
                    </p>
                  </div>
                </div>
        ...
        >
          <div className="glass-card border-prometh-amber p-5 md:p-6 flex items-start gap-4">
            <Shield className="w-6 h-6 text-prometh-amber flex-shrink-0 mt-0.5" />
            <p className="text-prometh-text text-sm md:text-base leading-relaxed">
              <span className="font-heading font-bold text-prometh-amber">
