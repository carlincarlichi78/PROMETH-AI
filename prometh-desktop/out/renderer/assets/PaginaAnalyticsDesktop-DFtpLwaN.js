import { aq as requireReactDom, r as reactExports, ar as getDefaultExportFromCjs, as as requireReact, at as React, j as jsxRuntimeExports, a as Shield, T as TriangleAlert, aa as PenLine, W as Workflow, $ as FileDown, y as Timer, ao as BellRing } from "./index-DMbE3NR1.js";
...
var _excluded$i = ["contextPayload"];
function _extends$m() {
...
function LegendContent(props) {
  var {
    contextPayload
  } = props, otherProps = _objectWithoutProperties$i(props, _excluded$i);
...
var _excluded$g = ["radius"], _excluded2$9 = ["radius"];
...
var Rectangle = (rectangleProps) => {
  ...
  if (!isUpdateAnimationActive) {
    var _svgPropertiesAndEven = svgPropertiesAndEvents(props), {
      radius: _
    } = _svgPropertiesAndEven, otherPathProps = _objectWithoutProperties$g(_svgPropertiesAndEven, _excluded$g);
  ...
  return /* @__PURE__ */ reactExports.createElement(JavascriptAnimate, {
    ...
    var _svgPropertiesAndEven2 = svgPropertiesAndEvents(props), {
      radius: _2
    } = _svgPropertiesAndEven2, otherPathProps2 = _objectWithoutProperties$g(_svgPropertiesAndEven2, _excluded2$9);
...
var _excluded$e = ["x", "y", "lineHeight", "capHeight", "fill", "scaleToFit", "textAnchor", "verticalAnchor"], _excluded2$8 = ["dx", "dy", "angle", "className", "breakAll"];
function _extends$f() {
...
var Text = /* @__PURE__ */ reactExports.forwardRef((outsideProps, ref) => {
  var _resolveDefaultProps = resolveDefaultProps(outsideProps, textDefaultProps), {
    ...
    textAnchor,
    verticalAnchor
  } = _resolveDefaultProps, props = _objectWithoutProperties$e(_resolveDefaultProps, _excluded$e);
  ...
  var {
    ...
    className,
    breakAll
  } = props, textProps = _objectWithoutProperties$e(props, _excluded2$8);
...
var _excluded$d = ["labelRef"], _excluded2$7 = ["content"];
...
function Label(outerProps) {
  ...
  if (typeof content === "function") {
    var {
      content: _2
    } = propsWithViewBox, propsForContent = _objectWithoutProperties$d(propsWithViewBox, _excluded2$7);
...
var _excluded$c = ["valueAccessor"], _excluded2$6 = ["dataKey", "clockWise", "id", "textBreakAll", "zIndex"];
function _extends$d() {
...
var _excluded$b = ["option", "shapeType", "activeClassName"];
...
var _excluded$a = ["key"], _excluded2$5 = ["onMouseEnter", "onClick", "onMouseLeave"], _excluded3$3 = ["id"], _excluded4$1 = ["id"];
function ownKeys$b(e, r2) {
  var t = Object.keys(e);
  if (Object.getOwnPropertySymbols) {
    var o = Object.getOwnPropertySymbols(e);
...
var renderLabelLineItem = (option, props) => {
  ...
  var {
    key
  } = props, otherProps = _objectWithoutProperties$a(props, _excluded$a);
...
function PieSectors(props) {
  ...
  } = allOtherPieProps, restOfAllOtherProps = _objectWithoutProperties$a(allOtherPieProps, _excluded2$5);
...
function PieImpl(props) {
  var {
    id
  } = props, propsWithoutId = _objectWithoutProperties$a(props, _excluded3$3);
  var {
    hide,
    className,
    rootTabIndex
...
function Pie(outsideProps) {
  ...
  var {
    id: externalId
  } = props, propsWithoutId = _objectWithoutProperties$a(props, _excluded4$1);
...
var _excluded$7 = ["x1", "y1", "x2", "y2", "key"], _excluded2$4 = ["offset"], _excluded3$2 = ["xAxisId", "yAxisId"], _excluded4 = ["xAxisId", "yAxisId"];
...
function HorizontalGridLines(props) {
  ...
  var {
    xAxisId,
    yAxisId
  } = props, otherLineItemProps = _objectWithoutProperties$7(props, _excluded3$2);
...
function CardKpi({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "cristal rounded-xl p-4 border border-white/[0.06]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `w-10 h-10 rounded-lg flex items-center justify-center ${colorIcono}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icono, { className: "w-5 h-5" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl font-bold text-white", children: valor }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-superficie-400", children: titulo }),
      subtitulo && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-superficie-500", children: subtitulo })
    ] })
  ] }) });
}
function TooltipCustom({ active, payload, label }) {
  if (!active || !payload?.length) return null;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-superficie-900 border border-white/[0.1] rounded-lg px-3 py-2 text-xs", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-superficie-400 mb-1", children: label }),
...
function PaginaAnalyticsDesktop() {
  const [metricas, setMetricas] = reactExports.useState(null);
  const [actividad, setActividad] = reactExports.useState([]);
  ...
  const cargar = reactExports.useCallback(async () => {
    ...
    try {
      setCargando(true);
      setError(null);
      const [m, a2] = await Promise.all([
        api.analytics.metricas(),
        api.analytics.actividadTemporal(30)
      ]);
      setMetricas(m);
      setActividad(a2);
    } catch (err) {
  ...
  const datosPie = metricas ? Object.entries(metricas.documentales.porTipo).sort((a2, b) => b[1] - a2[1]).slice(0, 8).map(([tipo, cantidad]) => ({ nombre: tipo.replace(/_/g, " "), valor: cantidad })) : [];
  if (!api?.analytics) return null;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold text-white", children: "Analytics local" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-superficie-400 mt-1", children: "Metricas del desktop: certificados, firmas, workflows, descargas" })
      ] }),
    ...
    !cargando && metricas && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-3 mb-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          CardKpi,
          {
            titulo: "Certs instalados",
            valor: metricas.certificados.totalInstalados,
            subtitulo: metricas.certificados.caducados > 0 ? `${metricas.certificados.caducados} caducados` : void 0,
            icono: Shield,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          CardKpi,
          {
            ...
            valor: metricas.certificados.proximosACaducar,
            subtitulo: "< 30 dias",
            icono: TriangleAlert,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          CardKpi,
          {
            titulo: "Firmas realizadas",
            valor: metricas.firmas.totalFirmados,
            subtitulo: metricas.firmas.pendientesSync > 0 ? `${metricas.firmas.pendientesSync} sin sync` : void 0,
            icono: PenLine,
            colorIcono: "bg-violet-500/10 text-violet-400"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          CardKpi,
          {
            titulo: "Workflows ejecutados",
            valor: metricas.workflows.totalEjecuciones,
            subtitulo: `${metricas.workflows.exitosas} ok / ${metricas.workflows.fallidas} error`,
            icono: Workflow,
            colorIcono: "bg-cyan-500/10 text-cyan-400"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          CardKpi,
          {
            titulo: "Descargas docs",
            valor: metricas.documentales.totalDescargas,
            subtitulo: `${metricas.documentales.exitosas} ok / ${metricas.documentales.fallidas} error`,
            icono: FileDown,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          CardKpi,
          {
            titulo: "Tareas scheduler",
            valor: metricas.scheduler.tareasActivas,
            subtitulo: `${metricas.scheduler.ejecucionesHoy} ejecuciones hoy`,
            icono: Timer,
            colorIcono: "bg-orange-500/10 text-orange-400"
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-4 mb-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "cristal rounded-xl p-5 border border-white/[0.06]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-semibold text-white mb-4", children: "Actividad ultimos 30 dias" }),
          actividad.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 220, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AreaChart, { data: actividad, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("defs", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: "gradFirmas", x1: "0", y1: "0", x2: "0", y2: "1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "5%", stopColor: COLORES_AREA.firmas, stopOpacity: 0.3 }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "95%", stopColor: COLORES_AREA.firmas, stopOpacity: 0 })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: "gradWorkflows", x1: "0", y1: "0", x2: "0", y2: "1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "5%", stopColor: COLORES_AREA.workflows, stopOpacity: 0.3 }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "95%", stopColor: COLORES_AREA.workflows, stopOpacity: 0 })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: "gradDescargas", x1: "0", y1: "0", x2: "0", y2: "1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "5%", stopColor: COLORES_AREA.descargas, stopOpacity: 0.3 }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "95%", stopColor: COLORES_AREA.descargas, stopOpacity: 0 })
              ] })
            ] }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { content: /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipCustom, {}) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Legend,
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Area, { type: "monotone", dataKey: "firmas", name: "Firmas", stroke: COLORES_AREA.firmas, fill: "url(#gradFirmas)", strokeWidth: 2 }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Area, { type: "monotone", dataKey: "workflows", name: "Workflows", stroke: COLORES_AREA.workflows, fill: "url(#gradWorkflows)", strokeWidth: 2 }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Area, { type: "monotone", dataKey: "descargas", name: "Descargas", stroke: COLORES_AREA.descargas, fill: "url(#gradDescargas)", strokeWidth: 2 })
          ] }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-superficie-500 text-center py-10", children: "Sin datos de actividad" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "cristal rounded-xl p-5 border border-white/[0.06]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-semibold text-white mb-4", children: "Descargas por tipo" }),
          datosPie.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 220, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(PieChart, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Pie,
              {
                data: datosPie,
                ...
                labelLine: false,
                children: datosPie.map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Cell, { fill: COLORES_PIE[i % COLORES_PIE.length] }, i))
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, {})
          ] }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-superficie-500 text-center py-10", children: "Sin datos de descargas" })
        ] })
      ] }),
      metricas.certificados.certificados.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "cristal rounded-xl border border-white/[0.06] overflow-hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-5 py-3 border-b border-white/[0.06]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-semibold text-white", children: "Estado de certificados" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-white/[0.04]", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-5 py-2 text-xs font-medium text-superficie-500 uppercase", children: "Titular" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-5 py-2 text-xs font-medium text-superficie-500 uppercase", children: "Vencimiento" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-right px-5 py-2 text-xs font-medium text-superficie-500 uppercase", children: "Dias" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-right px-5 py-2 text-xs font-medium text-superficie-500 uppercase", children: "Estado" })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: metricas.certificados.certificados.slice(0, 10).map((cert, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-white/[0.02] hover:bg-white/[0.02]", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-5 py-2.5 text-white truncate max-w-[250px]", children: cert.subject }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-5 py-2.5 text-superficie-400", children: new Date(cert.fechaVencimiento).toLocaleDateString("es-ES") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-5 py-2.5 text-right text-superficie-400", children: cert.diasRestantes }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-5 py-2.5 text-right", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `inline-flex px-2 py-0.5 rounded-full text-[10px] font-medium ${cert.diasRestantes <= 0 ? "bg-red-500/20 text-red-400" : cert.diasRestantes <= 7 ? "bg-red-500/20 text-red-400" : cert.diasRestantes <= 30 ? "bg-amber-500/20 text-amber-400" : "bg-emerald-500/20 text-emerald-400"}`, children: cert.diasRestantes <= 0 ? "Caducado" : cert.diasRestantes <= 7 ? "Critico" : cert.diasRestantes <= 30 ? "Proximo" : "Vigente" }) })
          ] }, i)) })
        ] }) })
      ] }),
      metricas.notificacionesDesktop.pendientes > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 flex items-center gap-3 px-4 py-3 bg-amber-500/5 border border-amber-500/20 rounded-lg", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(BellRing, { className: "w-4 h-4 text-amber-400" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-amber-400", children: [
          metricas.notificacionesDesktop.pendientes,
          " alerta(s) sin leer"
        ] })
      ] })
    ] })
